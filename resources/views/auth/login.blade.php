    ...
    <div class="login-container"   >
        <div class="login-card">
            <div class="login-header">
                <div class="logo-theme py-2 ">
                    <img class="logo-light" src="{{ asset('images/logo/library-logo.png') }}" alt="dch-Library-logo"
                        width="30%">
                    <img class="logo-dark " src="{{ asset('images/logo/library-logo.png') }}" alt="dch-Library-logo"
                        width="30%">
                </div>
                <div>
                    <p class="text-center fw-normal fs-6  ">  Manage the library’s books as well as medical college rules </p>
                </div>
            </div>
